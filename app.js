...
var UIController = (function() {
    ...
    var DOMstrings ={ 
        ...
        container: '.container',
        expensesPercLabal: '.item__percentage',
    ...
    var formatNumber = function(num ,type){
        ...
        comma sepatating the thousands
        2045.546 -> +2,045.55
        */
    ...
    return {
        ...
        displayBudget: function(obj){
            ...
            document.querySelector(DOMstrings.incomeLabal).textContent = formatNumber(obj.totalInc, 'inc');
            document.querySelector(DOMstrings.expensesLabal).textContent = formatNumber(obj.totalExp, 'exp');
        ...
        displayPercentages: function(percentages){
            ...
            fields = document.querySelectorAll(DOMstrings.expensesPercLabal);
        ...
        displayMonth: function() {
            ...
            months =['January', 'Fabruary', 'March', 'May', 'June', 'July', 'August', 'September', 'November', 'December'];
            month = now.getMonth();
...
var controller = (function(budgeCtrl, UICtrl){
    ...
    var setupEventListener = function() {
        ...
        document.querySelector(DOM.inputType).addEventListener('change', UICtrl.changedTyep)
    };
    ...
    var updatePercentages = function() {
        ...
        var percentage =  budgeCtrl.getPercentage();
